...
public class CloudBackendAsync extends CloudBackend {
  ...
  public void insert(
    ...
    CloudCallbackHandler<AppusagemonitorApiMessagesAppUsageResponseMessage> handler) 
  {
    (new BackendCaller<
	     AppusagemonitorApiMessagesAppUsageInsertRequest,
         AppusagemonitorApiMessagesAppUsageResponseMessage>(request, handler) 
       {
	     @Override
		 protected AppusagemonitorApiMessagesAppUsageResponseMessage callBackend(
           AppusagemonitorApiMessagesAppUsageInsertRequest param)
		   throws IOException 
		 {
  ...
  {
    (new BackendCaller<
	     AppusagemonitorApiMessagesAppUsageListByNameRequest,
         AppusagemonitorApiMessagesAppUsageListByNameResponse>(request, handler) 
       {
	     @Override
		 protected AppusagemonitorApiMessagesAppUsageListByNameResponse callBackend(
           AppusagemonitorApiMessagesAppUsageListByNameRequest param)
		   throws IOException 
		 {
		   return CloudBackendAsync.super.listByName(param);
	     }
       }
    ).start();
  }
